...
assert(loadfile("data/vanilla/druid.lua"))("druid", addon)
assert(loadfile("data/vanilla/hunter.lua"))("hunter", addon)
assert(loadfile("data/vanilla/warrior.lua"))("warrior", addon)
assert(loadfile("data/vanilla/mage.lua"))("mage", addon)
assert(loadfile("data/vanilla/paladin.lua"))("paladin", addon)
assert(loadfile("data/vanilla/priest.lua"))("priest", addon)
assert(loadfile("data/vanilla/rogue.lua"))("rogue", addon)
assert(loadfile("data/vanilla/shaman.lua"))("shaman", addon)
assert(loadfile("data/vanilla/warlock.lua"))("warlock", addon)
